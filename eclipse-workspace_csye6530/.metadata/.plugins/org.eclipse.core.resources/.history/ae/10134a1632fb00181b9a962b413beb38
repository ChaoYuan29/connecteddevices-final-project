...
public class MqttClientConnectorII implements MqttCallback
{
	    // static
	    private static final Logger _Logger = Logger.getLogger(MqttClientConnectorII.class.getName());
	    // params
	...
	*/
	public MqttClientConnectorII(String host, String protocol, int port){
	    	super();
